  ...
  inquirer.prompt([
    ...
    switch(response.route) {
      ...
      case "Roles":
        ...
        connection.query(query, [response.title,response.salary,response.department_id], function (err, res) {
          if (err) throw (err)
      ...
      case "Employees":
        ...
        connection.query(query, [response.first_name,response.last_name,response.role_id,managerID], function (err, res) {
          if (err) throw (err)
  ...
  connection.query("SELECT * FROM employee",function(err, res) {
    inquirer.prompt([
      ...
      .then(response => {
        ...
        connection.query(query, [response.role_id,name[0],name[1]], function(err,res){
          if (err) throw err;
  ...
  connection.query(query,function(err, res) {
    inquirer.prompt([
      ...
      .then(response => {
        ...
        var name = response.employee.split(" ")
        var managerID = (response.manager_id === "null") ?null :response.manager_id;
        connection.query(query, [managerID,name[0],name[1]], function(err,res){
          if (err) throw err;
